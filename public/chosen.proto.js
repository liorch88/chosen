...
(function() {
  ...
  AbstractChosen = (function() {
    ...
    AbstractChosen.prototype.result_add_option = function(option) {
      ...
      option_el.innerHTML = this.option_html_pattern.replace(this.option_text_token, option.search_text);
  ...
  this.Chosen = (function(_super) {
    ...
    Chosen.prototype.set_default_values = function() {
      ...
      this.single_temp = new Template('<a class="chosen-single chosen-default" tabindex="-1"><span>#{default}</span><div><b></b></div></a><div class="chosen-drop"><div class="chosen-search"><input type="text" autocomplete="off" placeholder="' + this.search_placeholder_text + '/></div><ul class="chosen-results"></ul></div>');
